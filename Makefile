...
exec: main.o Detector.o OpenGLRenderer.o Surface.o Ball.o Robot.o DBclient.o
	$(CC) DBclient.o OpenGLRenderer.o Detector.o Surface.o  Ball.o Robot.o main.o -o exec $(OPENCVLIBS) $(OPENGLLIBS)
main.o: main.cpp
